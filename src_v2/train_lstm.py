...
def main():
    ...
    parser.add_argument('--train_csv',
        type=str,
        default="/users/grad/papry/MS_thesis-main/data/20240820_121207/train_prev_rural_time0_None.csv",
        help='Path to train csv file')
    parser.add_argument(
        '--val_csv',
        type=str,
        default=f"/users/grad/papry/MS_thesis-main/data/20240820_121207/validation_prev_rural_time0_None.csv",
    ...
    parser.add_argument('--initial_epoch', type=int, default=501,
    ...
    parser.add_argument(
        '--resume_from_ckpt',
        type=str,
        default="/users/grad/papry/MS_thesis-main/logs/20240822_063711/ckpt",
