...
def main():
    ...
    parser.add_argument('--train_csv',
        type=str,
        default="/users/grad/papry/MS_thesis-main/data/20240823_062300/train_prev_rural_time4_None.csv",
        help='Path to train csv file')
    parser.add_argument(
        '--val_csv',
        type=str,
        default=f"/users/grad/papry/MS_thesis-main/data/20240823_062300/validation_prev_rural_time4_None.csv",
    ...
    parser.add_argument(
        '--resume_from_ckpt',
        type=str,
        default=None, #"/users/grad/papry/MS_thesis-main/logs/20240822_063711/ckpt",
    ...
    if args.autoencoder:
        callbacks.add_callback(
            ...
            callback=tf.keras.callbacks.ModelCheckpoint(    
                filepath=f'/users/grad/papry/MS_thesis-main/logs/{current_time}/ckpt',
