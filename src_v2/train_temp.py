...
from models import ModelManager, TransformerTimeseries_KC
...
def main():
    ...
    parser.add_argument('--train_csv',
        type=str,
        default="/home/papry/Exp_Project/MS_thesis-main/data/20250719_180144/train_prev_urban_time1_None.csv",
        help='Path to train csv file')
    parser.add_argument( 
        '--val_csv',
        type=str,
        default=f"/home/papry/Exp_Project/MS_thesis-main/data/20250719_180144/validation_prev_urban_time1_None.csv",
        help='Path to validation csv file'
        )
    parser.add_argument('--model', type=str, default="LSTMPlus_KC",
        help='model to use')
    ...
    parser.add_argument(
        '--resume_from_ckpt',
        type=str,
        default=None, #"/home/papry/Exp_Project/MS_thesis-main/logs/20250711_004813/ckpt",
        help='Resume training from a checkpoint'
        )
    args = parser.parse_args()
    current_time = datetime.datetime.now().strftime("%Y%m%d_%H%M%S")
    os.system(f"mkdir -p /home/papry/Exp_Project/MS_thesis-main/logs/{current_time}")
    with open(f'/home/papry/Exp_Project/MS_thesis-main/logs/{current_time}/train_args_34.txt', 'w') as file:
