...
def main():
    ...
    parser.add_argument('--train_csv',
        type=str,
        default="/home/papry/Exp_Project/MS_thesis-main/data/20250513_230206_34/train_new_urban_time1_None.csv",
        help='Path to train csv file')
    parser.add_argument(
        '--val_csv',
        type=str,
        default=f"/home/papry/Exp_Project/MS_thesis-main/data/20250513_230206_34/validation_new_urban_time1_None.csv",
    ...
    parser.add_argument(
        '--resume_from_ckpt',
        type=str,
        default=None, #"/users/grad/papry/MS_thesis-main/logs/20240905_123313/ckpt",
        help='Resume training from a checkpoint'
        )
    args = parser.parse_args()
    current_time = datetime.datetime.now().strftime("%Y%m%d_%H%M%S")
    os.system(f"mkdir -p /home/papry/Exp_Project/MS_thesis-main/logs/{current_time}")
    with open(f'/home/papry/Exp_Project/MS_thesis-main/logs/{current_time}/train_args.txt', 'w') as file:
