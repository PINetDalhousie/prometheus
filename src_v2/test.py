...
def main():
    ...
    parser.add_argument(
        '--test_csv',
        type=str,
        default="/users/grad/papry/MS_thesis-main/data/20240722_123046/test_new_rural_time0_None.csv",
        help='Path to test csv file'
        )
    parser.add_argument(
        '--model_path',
        type=str,
        default="/users/grad/papry/MS_thesis-main/logs/20240725_152225/ckpt",
        help='Path to trained model'
        )  
    parser.add_argument(
        '--log_path',
        type=str,
        default="/users/grad/papry/MS_thesis-main/logs/20240725_152225/",
   ...
   # data_preprocess.normalize_test_data(args.log_path)
    ...
    print(args.log_path+f'{current_time}_results.txt')
