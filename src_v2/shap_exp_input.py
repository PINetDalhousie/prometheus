...
for y in range(1,12):
    ...
    shap=np.loadtxt(f'/home/papry/Exp_Project/MS_thesis-main/logs/20251008_010449/shap{y}_new_data.txt')

    data = np.loadtxt(f'/home/papry/Exp_Project/MS_thesis-main/logs/20251008_010449/input{y}_new_data.txt')
    ...
    print(data.shape)
    print(label_list[8], data[0,0,9], data[1,0,9], data[2,0,9])
    ...
    plt.savefig(f'input{y}_boxplots_urban.pdf', bbox_inches='tight', pad_inches=0.3)
    plt.show()