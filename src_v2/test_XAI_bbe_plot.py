...
def main():
    ...
    parser.add_argument(
        '--test_csv',
        type=str,
        default="/users/grad/papry/MS_thesis-main/data/20240310_151048/test_new_rural_time4_None.csv",
        help='Path to test csv file'
        )
    parser.add_argument(
        '--model_path',
        type=str,
        default="/users/grad/papry/MS_thesis-main/logs/20241121_113650/ckpt",
        help='Path to trained model'
        )  
    parser.add_argument(
        '--log_path',
        type=str,
        default="/users/grad/papry/MS_thesis-main/logs/20241121_113650/",
